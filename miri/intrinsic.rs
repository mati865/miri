...
use rustc_mir::interpret::{Place, HasMemory, EvalContext, ValTy, PlaceExtra};
    ...
    fn call_intrinsic(
        ...
        match intrinsic_name {
            ...
            "atomic_xsub_relaxed" => {
                ...
                self.write_primval(Place::from_primval_ptr(ptr, align), val, ty)?;
            }
            ...
            "discriminant_value" => {
                ...
                let align = self.layout_of(ty)?.align;
                let place = Place::from_primval_ptr(adt_ptr, align);
            ...
            "transmute" => {
                ...
                // FIXME: is this alignment correct?
                let align = Align::from_bytes(1, 1).unwrap();
                self.write_value_to_ptr(args[0].value, ptr.into(), align, src_ty)?;
            }
